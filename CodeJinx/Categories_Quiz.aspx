<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Categories_Quiz.aspx.cs" Inherits="Demo" %>
...
<head id="Head1" runat="server">
    <title>CodeJinx | Categories Quiz</title>
...
<body style="height: 18px" bgcolor="White">
    ...
    <asp:Panel ID="Panel2" runat="server" 
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" 
            ...
            PostBackUrl="~/C_Quiz.aspx"> C</asp:LinkButton>
    ...
    <asp:Panel ID="Panel3" runat="server" 
        ...
        <asp:LinkButton ID="LinkButton2" runat="server" 
            ...
            PostBackUrl="~/CPP_Quiz.aspx">C++</asp:LinkButton>
              </asp:Panel>
    ...
    <asp:Panel ID="Panel4" runat="server" 
        ...
        <asp:LinkButton ID="LinkButton3" runat="server" 
            ...
            Font-Size="XX-Large" Font-Underline="False" ForeColor="Black" 
            PostBackUrl="~/C_sharp_Quiz.aspx">C#</asp:LinkButton>
    ...
    <asp:Panel ID="Panel7" runat="server" 
        ...
        <asp:Label ID="Label9" runat="server" ForeColor="Gray" 
            style="z-index: 1; left: 1009px; top: 103px; position: absolute" 
    ...
    <asp:Label ID="Label11" runat="server" 
        style="z-index: 1; left: 550px; top: 137px; position: absolute" 
        Text="Succesfully LoggedIn.Choose your Category"></asp:Label>
    <asp:LinkButton ID="LinkButton13" runat="server" 
        PostBackUrl="~/Categories.aspx" 
        style="z-index: 1; left: 1187px; top: 134px; position: absolute">LogOut</asp:LinkButton>
    </form>
</body>
</html>
